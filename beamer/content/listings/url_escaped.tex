...
Diese Fußnote\color{nounibaredI}\color{nounibaredI}\textbackslash footnote\color{black}\{\color{nounibaredI}\textbackslash url\color{black}\{https://wiai.de\}\} enthält eine URL als klickbaren Link.\color{nounibaredI}\color{nounibaredI}\textbackslash \color{nounibaredI}\textbackslash \color{black} \\
