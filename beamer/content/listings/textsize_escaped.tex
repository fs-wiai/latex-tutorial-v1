...
\color{nounibaredI}\color{nounibaredI}\textbackslash small\color{black}~klein \color{nounibaredI}\color{nounibaredI}\textbackslash \color{nounibaredI}\textbackslash \color{black} \\
\color{nounibaredI}\color{nounibaredI}\textbackslash normalsize\color{black}~Standardgröße \color{nounibaredI}\color{nounibaredI}\textbackslash \color{nounibaredI}\textbackslash \color{black} \\
...
\color{nounibaredI}\color{nounibaredI}\textbackslash Huge\color{black}~gigantisch \color{nounibaredI}\color{nounibaredI}\textbackslash \color{nounibaredI}\textbackslash \color{black} \\
