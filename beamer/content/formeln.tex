...
Um Ausdrücke in einer eigenen Zeile abzusetzen, kann man sie auch in {\ttfamily\color{unibayellowI}\$\$\color{nounibaredI} \ldots \color{unibayellowI}\$\$} schreiben. 
...
Code:\\
{\ttfamily \color{unibayellowI}\$\$	\color{nounibaredI}\textbackslash\color{nounibaredI}sum\textbackslash  limits\_\color{black}\{i=1\}\color{nounibaredI}\^{}\color{black}\{n+1\} (n \color{nounibaredI}\textbackslash \color{nounibaredI}cdot \color{black}2) - 5 \color{unibayellowI}\$\$}

\medskip

\begin{block}{Indizes und Potenzen}
Durch {\ttfamily \^{}\{\} und \_\{\} } werden Inhalte hoch- und tiefgestellt. \\
\begin{center}
$x_{i,j} = i^{j}$ \\ {\ttfamily \color{unibayellowI}\$	\color{nounibaredI}x\_\{i,j\} = i\^{}\{j\} \color{unibayellowI}\$}
\end{center}
...
\end{column}
\begin{column}{.6\textwidth}
{\ttfamily \color{unibayellowI} \$ \color{nounibaredI}\textbackslash land\color{black}, \color{nounibaredI}\textbackslash lor\color{black}, \color{nounibaredI}\textbackslash oplus, \color{nounibaredI}\textbackslash lnot \color{unibayellowI} \$ }
\end{column}
\end{columns}
\bigskip
\begin{columns}
