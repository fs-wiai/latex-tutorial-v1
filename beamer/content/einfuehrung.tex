...
\begin{itemize}
  ...
  \item TeXMaker\footnote{http://www.xm1math.net/texmaker}\\
   Grundlage von TeXstudio, ähnlich aber weniger mächtig.
...
\begin{itemize}
  \item ShareLatex\footnote{https://www.sharelatex.com/, https://github.com/sharelatex/}\\
  Teilweise Open-Source, Hosted-Version kostenlos für Single-User
  \item Overleaf\footnote{https://www.overleaf.com/}\\
  Teilweise Kostenpflichtig, Hosted
  \item FlyLatex\footnote{https://github.com/alabid/flylatex}\\ 
  OpenSource, weniger mächtig
  \item Viele Weitere ...
  \vspace{7mm}
  \item Es gibt auch Git!
\end{itemize}
\end{frame}
