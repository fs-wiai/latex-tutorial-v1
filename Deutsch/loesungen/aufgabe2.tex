...
\usepackage{babel}
%% Nicht vergessen: weitere Packages:
\usepackage{hyperref}
\usepackage{url}
...
Die Hauskatze ist ein fleischfressendes Säugetier. Sie wird seit mindestens 9500 Jahren als \underline{Haustier} gehalten\footnote{Quelle: \url{http://de.wikipedia.org/wiki/Hauskatze}}.
