...
\begin{itemize}
  ...
  \item \color{unibablueI}\textbackslash section\color{black}\{Titel\}
  \item \color{unibablueI}\textbackslash subsection\color{black}\{Untertitel\}
...
Weitere Untergliederungsmöglichkeiten für Bücher (d.\,h., nur in {\ttfamily book} neben \begin{ttfamily}\color{unibablueI}\textbackslash section\color{black}s\end{ttfamily}):
\begin{itemize}
...
%\bigskip 
\begin{block}{Hinweis}
    \footnotesize Merkhilfe: \textbf{g}erman/\textbf{f}rench \textbf{l}eft/\textbf{r}ight \textbf{q}uote \textbf{q}uote (vgl.\ einfache Anführungszeichen)\\

    Ein nicht trennbares Leerzeichen (z.\,B. nach Sonderzeichen) wird durch eine \color{nounibaredI} $\sim$ \color{black} (Tilde) erzeugt.
\end{block}
\vspace{-8mm}
...
\hline
\ttfamily \color{nounibaredII}\ttfamily \textbackslash slash \color{black} & \color{nounibaredII} \ttfamily \textbackslash textbackslash \color{black} & \color{nounibaredII} \ttfamily \textbackslash euro \color{black} & \ttfamily \~ ~ \rmfamily \\
 \hline
\slash & \textbackslash & \euro & ~  \\
 \hline
\end{tabular} 
...
\hline
\ttfamily \color{nounibaredII}\ttfamily \textbackslash glqq \color{black} & \color{nounibaredII} \ttfamily \textbackslash grqq \color{black} & \color{nounibaredII} \ttfamily \textbackslash flqq \color{black}&  \color{nounibaredII} \ttfamily \textbackslash frqq \color{black} & \ttfamily - & \ttfamily -- & \ttfamily --- \\
 \hline
\glqq & \grqq & \flqq & \frqq & - & --  & --- \\
 \hline
\end{tabular} 
